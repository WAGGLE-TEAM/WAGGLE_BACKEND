package com.trip.api.domain.report.service;

import com.trip.api.domain.chatting.repository.ChatMessageRepository;
import com.trip.api.domain.chatting.repository.ChatRoomRepository;
import com.trip.api.domain.report.repository.ReportChatMessageRepository;
import com.trip.api.domain.report.dto.param.ConvertChatMessageReportParameter;
import com.trip.api.domain.report.dto.param.ConvertChatRoomReportParameter;
import com.trip.api.domain.report.dto.param.CreateChatMessageReportParameter;
import com.trip.api.domain.report.dto.param.CreateChatRoomReportParameter;
import com.trip.api.domain.report.entity.ReportChatMessage;
import com.trip.api.domain.report.entity.ReportChatRoom;
import com.trip.api.domain.report.mapper.ReportMapper;
import com.trip.api.domain.report.repository.ReportChatRoomRepository;
